...
const SupportBanner = ({ children }) => {
  ...
  return (
    <div className="support-banner">
      ...
      <div className="support-banner__row">
        <div className="support-banner__heading">{t("heading-2")}</div>
        {children && (
          <div className="support-banner__logo-container">{children}</div>
        )}
        <div className="support-banner__logo-container">
          <img
            src={goetheLogo}
